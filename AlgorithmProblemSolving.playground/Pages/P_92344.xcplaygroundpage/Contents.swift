...
func solution(_ board:[[Int]], _ skill:[[Int]]) -> Int {
    var board = board
    var sum = [[Int]](repeating: [Int](repeating: 0, count: board.first!.count), count: board.count)
    
    var firstRow = 0, firstColumn = 0
    var lastRow = 0, lastColumn = 0
    for s in skill {
        
        let degree = (s[0] == 2 ? 1 : -1) * s[5]
